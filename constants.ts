...
export const GAME_ENGINE = {
  ...
  NEAR_MISS_RING_START_RADIUS: 10,
  NEAR_MISS_RING_RADIUS: 46,
  NEAR_MISS_RING_LINE_WIDTH: 2,
  ...
  IMPACT_RING_LIFE_DECAY: 0.045,
  KILL_RING_START_RADIUS: 8,
  KILL_RING_RADIUS_NORMAL: 34,
  KILL_RING_RADIUS_CRIT: 52,
  KILL_RING_RADIUS_WHALE: 84,
  KILL_RING_LINE_WIDTH_NORMAL: 2,
  KILL_RING_LINE_WIDTH_CRIT: 4,
  COLLECTION_RING_START_RADIUS: 4,
  COLLECTION_RING_RADIUS_NORMAL: 20,
  COLLECTION_RING_RADIUS_RARE: 32,
  COLLECTION_RING_LINE_WIDTH_NORMAL: 1.5,
  COLLECTION_RING_LINE_WIDTH_RARE: 2.5,
  ENEMY_HIT_IMPACT_DECAY: 0.14,
  ENEMY_HIT_RECOIL_DISTANCE: 5,
  ENEMY_HIT_RECOIL_CRIT_MULT: 1.5,
  ENEMY_HIT_SQUASH_X: 0.16,
  ENEMY_HIT_SQUASH_Y: 0.12,
