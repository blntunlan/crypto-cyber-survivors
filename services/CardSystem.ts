...
const COMMON_CARDS: Card[] = [
    ...
    },
    {
        ...
        icon: '/assets/icons/cards/quick-trade-tier1.png',
        tier: 'common',
    ...
    },
    {
        ...
        icon: '/assets/icons/cards/safety-net-tier1.png',
        tier: 'common',
    ...
    },
    {
        ...
        icon: '/assets/icons/cards/yield-farm-tier1.png',
        tier: 'common',
    ...
    },
    {
        ...
        name: 'Stop Loss',
        description: '+1 Armor',
        icon: '/assets/icons/cards/stop-loss-tier1.png',
        tier: 'common',
    ...
    // NEW CARDS
    {
        ...
        icon: '/assets/icons/cards/sniper-bot-tier1.png',
        tier: 'common',
    ...
    },
    {
        ...
        icon: '/assets/icons/cards/dca-mode-tier1.png',
        tier: 'common',
    ...
    },
    {
        ...
        icon: '/assets/icons/cards/rebalance-tier1.png',
        tier: 'common',
        effect: p => ({
            ...p,
...
const RARE_CARDS: Card[] = [
    {
        ...
        icon: '/assets/icons/cards/limit-order-tier2.png',
        tier: 'rare',
    ...
    },
    {
        ...
        icon: '/assets/icons/cards/market-cap-tier2.png',
        tier: 'rare',
    ...
    // NEW CARDS
    {
        ...
        icon: '/assets/icons/cards/double-down-tier2.png',
        tier: 'rare',
    ...
    },
    {
        ...
        icon: '/assets/icons/cards/bull-run-tier2.png',
        tier: 'rare',
    ...
    },
    {
        ...
        icon: '/assets/icons/cards/hodl-shield-tier2.png',
        tier: 'rare',
    ...
    },
    {
        ...
        icon: '/assets/icons/cards/short-squeeze-tier2.png',
        tier: 'rare',
        effect: p => ({
            ...p,
...
const EPIC_CARDS: Card[] = [
    {
        ...
        icon: '/assets/icons/cards/leverage-trade-tier3.png',
        tier: 'epic',
        effect: p => ({
            ...p,
    ...
    },
    {
        ...
        icon: '/assets/icons/cards/staking-rewards-tier3.png',
        tier: 'epic',
    ...
    },
    {
        ...
        icon: '/assets/icons/cards/flash-loan-tier3.png',
        tier: 'epic',
        effect: p => ({
            ...p,
    ...
    },
    {
        ...
        icon: '/assets/icons/cards/cold-wallet-tier3.png',
        tier: 'epic',
    ...
    // NEW CARDS
    {
        ...
        icon: '/assets/icons/cards/liquidation-tier3.png',
        tier: 'epic',
    ...
    },
    {
        ...
        icon: '/assets/icons/cards/lightning-network-tier3.png',
        tier: 'epic',
        effect: p => ({
            ...p,
    ...
    },
    {
        ...
        icon: '/assets/icons/cards/smart-contract-tier3.png',
        tier: 'epic',
    ...
    },
    {
        ...
        icon: 'icon-banano',
        tier: 'epic',
        effect: p => ({ ...p, speed: Math.min(12, p.speed * 1.2), luck: Math.min(15, p.luck + 0.5) }),
    },
];
...
const LEGENDARY_CARDS: Card[] = [
    {
        ...
        icon: '/assets/icons/cards/diamond-hands-tier4.png',
        tier: 'legendary',
        effect: p => ({
            ...p,
    ...
    },
    {
        ...
        icon: '/assets/icons/cards/bull-run-tier3.png',
        tier: 'legendary',
...
// Export all cards as flat array for slot machine effect
