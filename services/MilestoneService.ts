...
const MILESTONES: MilestoneConfig[] = [
    // Kill Milestones
    { id: 'kills_100', name: 'CENTURION', type: 'kills', threshold: 100, icon: '⚔️', color: '#c0c0c0' },
    { id: 'kills_250', name: 'SLAYER', type: 'kills', threshold: 250, icon: '🗡️', color: '#ffd700' },
    { id: 'kills_500', name: 'DESTROYER', type: 'kills', threshold: 500, icon: '💀', color: '#ff6b00' },
    { id: 'kills_1000', name: 'ANNIHILATOR', type: 'kills', threshold: 1000, icon: '🔥', color: '#ff0000' },
    { id: 'kills_2500', name: 'LEGEND', type: 'kills', threshold: 2500, icon: '👑', color: '#a855f7' },

    // Time Milestones (seconds)
    { id: 'time_60', name: '1 MINUTE!', type: 'time', threshold: 60, icon: '⏱️', color: '#22c55e' },
    { id: 'time_180', name: '3 MINUTES!', type: 'time', threshold: 180, icon: '⏱️', color: '#3b82f6' },
    { id: 'time_300', name: '5 MINUTES!', type: 'time', threshold: 300, icon: '⏱️', color: '#f59e0b' },
    { id: 'time_600', name: '10 MINUTES!', type: 'time', threshold: 600, icon: '🏆', color: '#ef4444' },
...
class MilestoneServiceClass {
    ...
    static getInstance(): MilestoneServiceClass {
        if (!MilestoneServiceClass.instance) {
            MilestoneServiceClass.instance = new MilestoneServiceClass();
        }
        return MilestoneServiceClass.instance;
    }
