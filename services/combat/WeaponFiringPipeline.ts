...
const targetingViewportBounds: ViewportBounds = { left: 0, right: 0, top: 0, bottom: 0 };
...
function findNearestEnemy(
  ...
  if (screenWidth > 0 && screenHeight > 0) {
    updateViewportBounds(targetingViewportBounds, screenWidth, screenHeight, TARGETING_VIEWPORT_PADDING);
    viewportBounds = targetingViewportBounds;
  }
