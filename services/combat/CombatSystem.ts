...
export class CombatSystem implements ICombatSystem {
   ...
   */
  /** Pre-allocated viewport bounds for culling. */
  private _viewportBounds: ViewportBounds = createViewportBounds(0, 0, 0);
