...
export class MovementSystem implements IMovementSystem {
  ...
  private updateEnemies(
    ...
    // ⚡ Bolt Optimization: Use standard for-loop instead of .forEach
    // to avoid inline closure allocations and reduce GC pressure every frame.
  ...
  private updateSpeedLines(pool: IPoolManager, dtFactor: number): void {
    // ⚡ Bolt Optimization: Zero-allocation loop
