...
export class MovementSystem implements IMovementSystem {
  ...
  private updateEnemies(
    ...
    // Optimization: Standard for loop to prevent closure function allocations in the update loop
  ...
  private updateSpeedLines(pool: IPoolManager, dtFactor: number): void {
    // Optimization: Standard for loop to prevent closure function allocations
