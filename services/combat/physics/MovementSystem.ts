...
export class MovementSystem implements IMovementSystem {
  ...
  private updateEnemies(
    ...
    // OPTIMIZATION: Replaced forEach with standard for-loop to eliminate closure allocations
    // and reduce garbage collection pressure in this high-frequency hot path.
