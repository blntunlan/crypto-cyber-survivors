...
export class MovementSystem implements IMovementSystem {
   ...
   *
   * PERFORMANCE: Uses standard for loops instead of Array.prototype.forEach to avoid closure
   * function allocations and reduce garbage collection pressure in this high-frequency 60 FPS hot path.
   */
