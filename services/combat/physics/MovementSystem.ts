...
export class MovementSystem implements IMovementSystem {
  ...
  private updateEnemies(
    ...
    // Architectural Optimization: Replace forEach with standard for loop to prevent closure allocations
    // and minimize GC pressure in the 60 FPS hot loop. Return statements are mapped to continue.
