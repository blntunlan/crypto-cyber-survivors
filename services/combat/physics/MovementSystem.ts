...
export class MovementSystem implements IMovementSystem {
  ...
  private updateEnemies(
    ...
    // Optimization: Standard for-loop to prevent closure allocation per enemy
  ...
  private updateSpeedLines(pool: IPoolManager, dtFactor: number): void {
    // Optimization: Standard for-loop to prevent closure allocation per line
  ...
  private updateImpactRings(pool: IPoolManager, dtFactor: number): void {
    // Optimization: Standard for-loop to prevent closure allocation per ring
  ...
  private updateParticles(pool: IPoolManager, dtFactor: number): void {
    ...
    // Optimization: Standard for-loop to prevent closure allocation per particle
  ...
  private updateFloatingTexts(pool: IPoolManager, dtFactor: number): void {
    // Optimization: Standard for-loop to prevent closure allocation per text
