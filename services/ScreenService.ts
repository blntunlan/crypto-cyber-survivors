...
class ScreenServiceClass {
    ...
    static getInstance(): ScreenServiceClass {
        if (!ScreenServiceClass.instance) {
            ScreenServiceClass.instance = new ScreenServiceClass();
        }
        return ScreenServiceClass.instance;
    }
    ...
    isPWA(): boolean {
        ...
        // iOS Safari specific
        const iosSafariStandalone = (window.navigator as Navigator & { standalone?: boolean }).standalone === true;
