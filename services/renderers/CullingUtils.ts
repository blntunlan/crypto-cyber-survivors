...
/**
 * Updates an existing viewport bounds object in-place to avoid allocation overhead.
 * Modifying existing objects is faster in high-frequency rendering loops.
 */
