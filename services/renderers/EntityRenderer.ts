...
export class EntityRenderer implements IRenderer {
  ...
  private drawInteractables(
    ...
    // Performance: Standard for-loop instead of forEach avoids closure allocations in hot 60fps render loop
  ...
  private drawGems(
    ...
    // Performance: Standard for-loop avoids closure allocations
