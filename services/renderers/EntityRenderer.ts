...
export class EntityRenderer implements IRenderer {
  ...
  private drawInteractables(
    ...
    // Optimization: Standard for loop to reduce GC pressure and closure allocations
  ...
  private drawGems(
    ...
    // Optimization: Standard for loop to reduce GC pressure
  ...
  private drawBuffGems(
    ...
    // Optimization: Standard for loop to avoid closure allocations
  ...
  private drawEnemies(
    ...
    // Optimization: Standard for loop to reduce closure overhead
  ...
  private drawPlayer(
    ...
    // Optimization: Standard for loop
