...
// Error Boundary for LevelUpScreen debugging
...
class LevelUpErrorBoundary extends Component<
  { children: React.ReactNode; debugInfo: string },
  ErrorBoundaryState
> {
  constructor(props: { children: React.ReactNode; debugInfo: string }) {
    super(props);
...
const MemoizedCardIcon = React.memo(
  ({ card, color, scaleDown = false }: { card: Card; color: string; scaleDown?: boolean }) => {
