      ...
      <div className="text-center space-y-4 max-w-sm w-full px-6 my-auto">
        ...
        <div className="bg-slate-900/50 border border-white/5 rounded-xl p-4 mb-6 grid grid-cols-2 gap-4">
          <div className="text-left">
            ...
            <p className="text-lg font-bold text-white font-stats">
          ...
          <div className="text-left">
            ...
            <p className="text-lg font-bold text-white font-stats">{runStats.totalKills}</p>
          </div>
          <div className="text-left">
            <p className="text-[10px] text-slate-500 font-black uppercase tracking-wider">
              Max Combo
            </p>
            <p className="text-lg font-bold text-white font-stats">{runStats.maxStreak}</p>
          </div>
          <div className="text-left">
            <p className="text-[10px] text-slate-500 font-black uppercase tracking-wider">
              Bonus XP
