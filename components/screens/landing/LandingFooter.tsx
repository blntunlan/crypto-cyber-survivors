      ...
      <>
            ...
            <div>
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="cursor-not-allowed border border-white/10 p-2 opacity-40"
                ...
                {/* Twitter/X - TODO: Replace with real link, then enable */}
                <button
                  type="button"
                  disabled
        ...
        {showBackToTop && (
          <m.button
            ...
            className="fixed z-[60] hidden h-10 touch-manipulation items-center gap-2 border border-white/10 bg-white/5 px-4 font-mono text-xs font-semibold uppercase tracking-widest text-slate-400 backdrop-blur-sm transition-all duration-300 hover:border-[#d6b85c]/40 hover:bg-white/10 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#d6b85c] active:scale-95 md:flex"
            title="Back to Top"
            style={{
