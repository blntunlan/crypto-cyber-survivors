...
const MobileAchievement: React.FC<AchievementPopupProps> = ({ achievement }) => {
    ...
    return (
        <div
            className="absolute top-48 right-4 z-[140] pointer-events-none w-[200px]"
            style={{
        ...
        >
            <div
                className="flex items-center gap-2.5 px-4 py-2 rounded-lg border shadow-lg backdrop-blur-sm"
                style={{
            ...
            >
                ...
                <div className="flex flex-col">
                    <span className="text-[8px] font-bold uppercase tracking-widest text-cyan-400">ACHIEVEMENT UNLOCKED</span>
                    <span className="text-sm font-black italic tracking-tight text-white leading-none mt-0.5">{achievement.name}</span>
                </div>
            </div>
        </div>
    );
