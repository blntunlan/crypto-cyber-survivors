        ...
        <div className="fixed bottom-20 right-4 w-72 bg-slate-900/90 border border-amber-500/40 rounded-xl p-4 z-[9999] shadow-[0_0_30px_rgba(245,158,11,0.15)] backdrop-blur-md">
            <div className="flex justify-between items-center mb-4">
                <div className="flex items-center gap-2">
                    ...
                    <h3 className="text-amber-500 font-bold uppercase tracking-wider text-[10px]">Combo Debugger</h3>
                </div>
            ...
            <div className="space-y-4">
                ...
                <div className="space-y-2">
                    <div className="text-[9px] text-slate-500 uppercase font-bold tracking-widest pl-1">Simulation</div>
                        ...
                        {COMBO_MILESTONES.map((m) => {
                            ...
                            return (
                                <div key={m.kills} className="flex justify-between items-center">
                                    <div className="flex items-center gap-2">
                                        <div className={`w-1 h-1 rounded-full ${isAchieved ? 'bg-amber-500 shadow-[0_0_4px_#f59e0b]' : 'bg-slate-800'}`}></div>
                                        <span className={`text-[9px] ${isAchieved ? 'text-amber-500/80 font-bold' : 'text-slate-600'}`}>
                                            {m.name}
                                        </span>
                                    </div>
                                    <span className={`text-[8px] ${isAchieved ? 'text-amber-500/60' : 'text-slate-700'}`}>
                                        {m.kills} kills
                                    </span>
                                </div>
                            );
