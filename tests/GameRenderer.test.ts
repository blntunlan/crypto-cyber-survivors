...
describe('GameRenderer', () => {
  ...
  describe('updateBackgroundCandles', () => {
    it('should move candles up when PnL is positive', () => {
      ...
      renderer.updateBackgroundCandles(mockState, 0.05, 1.0, 1, 800, 600);
    ...
    it('should increase speed with wave multiplier', () => {
      ...
      renderer.updateBackgroundCandles(lowDiffState, 0.05, 0.5, 1, 800, 600); // Low wave mult
      const lowDiffMovement = 200 - lowDiffState.bgCandles[0]!.y;

      renderer.updateBackgroundCandles(highDiffState, 0.05, 1.5, 1, 800, 600); // High wave mult (climax)
