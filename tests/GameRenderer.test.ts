...
describe('GameRenderer', () => {
    ...
    describe('updateBackgroundCandles', () => {
        ...
        it('should increase speed with difficulty', () => {
            const lowDiffState = { ...mockState, bgCandles: [{ x: 100, y: 200, w: 20, h: 50, color: '#22c55e', speed: 1 }] };
            const highDiffState = { ...mockState, bgCandles: [{ x: 100, y: 200, w: 20, h: 50, color: '#22c55e', speed: 1 }] };
