...
describe('PhysicsSystem', () => {
    ...
    describe('updateEntities', () => {
        it('should update bullet positions based on velocity', () => {
            mockPool.activeBullets = [
                { x: 100, y: 100, vx: 10, vy: 5, active: true },
            ];
        ...
        it('should deactivate bullets that go off screen', () => {
            mockPool.activeBullets = [
                { x: -150, y: 100, vx: -10, vy: 0, active: true },
            ];
        ...
        it('should update particle positions and life', () => {
            mockPool.activeParticles = [
                { x: 100, y: 100, vx: 2, vy: -2, life: 1, active: true },
            ];
        ...
        it('should deactivate particles when life reaches 0', () => {
            mockPool.activeParticles = [
                { x: 100, y: 100, vx: 0, vy: 0, life: 0.01, active: true },
            ];
        ...
        it('should update floating text positions and fade', () => {
            mockPool.activeFloatingTexts = [
                { x: 100, y: 200, life: 1, active: true },
            ];
        ...
        it('should scale movement by delta time factor', () => {
            mockPool.activeBullets = [
                { x: 100, y: 100, vx: 10, vy: 0, active: true },
            ];
    ...
    describe('handleCollisions', () => {
        ...
        it('should collect gems when player touches them', () => {
            mockPool.activeGems = [
                { x: 405, y: 300, radius: 5, value: 10, active: true },
            ];
            mockPlayer.exp = 0;
        ...
        it('should pull gems towards player within magnet range', () => {
            mockPool.activeGems = [
                { x: 450, y: 300, radius: 5, value: 10, active: true },
            ];
