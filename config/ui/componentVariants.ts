  ...
  cyberpunk: {
    ...
    selectionCard: {
      ...
      variant: {
        ...
        leverage:
          'rounded-lg border-[color:color-mix(in_srgb,var(--ui-selection-accent)_22%,transparent)] bg-[color:color-mix(in_srgb,var(--ui-selection-accent)_5%,var(--ui-surface-inset))] font-cyber font-bold tracking-wide text-[color:color-mix(in_srgb,var(--ui-selection-accent)_58%,var(--ui-text-muted))] hover:border-[color:color-mix(in_srgb,var(--ui-selection-accent)_48%,transparent)] hover:text-[color:var(--ui-selection-accent)]',
        position:
